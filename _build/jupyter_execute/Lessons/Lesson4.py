...
# - Electronic effects vs. steric effects the example of the anomeric effect (Ch. 2.4)
# 
# -----
# ## 4.2 Learning Goals
...
# - Interpret the steric strain present in a molecule by examining its con- formation.
# - Predict the enthalpy change for a reaction using group increments.
# - Use experimental enthalpy changes and calculated enthalpy changes to identify steric strain and resonance stabilization.
# 
# -----
# ## 4.3 Assignment \#4
# 
