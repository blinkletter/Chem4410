...
#     - Introduce idea of difference in equilibrium for these two reactions.
...
# The deliverable is what you ”deliver” to your instructor. Quite often **assignments** will have many questions to answer, but each individual student will be assigned a subset of those questions to include in a **report**. Always **read the instructions** and deliverable sections carefully. These detail what I want you to do and what I want you to hand in to me. Use this information to give me what I want - the customer is always right.
# 
...
# 
# #### Suggested Problems
# During our first meeting we will attempt a few selections the following **problems** in from appendix 5. You should attempt **all** of them on your own after the class. I have copied the appendix 5 questions from the textbook and made them available on the Moodle site. Please acquire a copy of the textbook soon as I won’t be able to do this again. Respect copyright - someday you may be an author.
# 
