...
# The land on which the University of Prince Edward Island is located is **Epekwitk**, the traditional and current territory of the **Mi’kmaq People** of this region. Epekwitk, which is the Mi’kmaq name for the area now known as Prince Edward Island, is one of seven traditional Mi’kmaq regions i
# n Mi’kma’ki (the ancestral lands that comprise Atlantic Canada, and parts of eastern Quebec and Maine). Mi’kma’ki is the ancestral and unceded territory of the Mi’kmaq people, who, in 1725 first signed the **Treaties of Peace and Friendship** with the British Crown. Those treaties did not deal with the surrender of lands and resources, but instead recognized Mi’kmaq title and negotiated a path toward an ongoing relationship between nations. We acknowledge we carry out our daily work in Mi’kma’ki.
